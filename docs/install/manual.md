...
- **Node.js 24+ LTS** (Astro 7 requiere ≥22.12, usamos Node 24 porque es la LTS actual con el EOL más lejano — abril 2029). Verificá con `node -v`.
- **npm 10+** (incluido con Node 24).
